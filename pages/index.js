              ...
              <div className="w-full max-w-sm">
                <form className="bg-white rounded px-8 pt-6 pb-8 mb-4">
                  ...
                  <div className="mb-4">
                    ...
                    <textarea className="form-textarea mt-1 block shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" rows="3" placeholder="Task Activity">
                    </textarea>
                  </div>
                  <div className="mb-4">
